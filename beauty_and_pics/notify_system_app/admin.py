...
def send_email_notify(request, *args, **kwargs):
	...
	if form.is_valid():
            ...
            notify_obj.create_recipients_list(retrieve_all_users=int(request.POST.get('addictional_recipients_emails')), campaign_contacts_list=campaign_contacts_list, addictional_email_string=str(request.POST.get('addictional_recipients_emails')))
