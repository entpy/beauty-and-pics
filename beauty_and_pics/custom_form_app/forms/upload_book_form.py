...
class profileImageForm(forms.Form, FormCommonUtils):
    ...
    widget_attr = {
	    ...
	    'base_modal_description_text': "Per caricare un'immagine clicca sul pulsante sotto.<br />ATTENZIONE: le immagini non ritenute adatte ai fini del concorso verranno eliminate automaticamente.",
