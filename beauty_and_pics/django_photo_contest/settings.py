...
DPC_PHOTO_CONTEST_INFO = {
    ...
    'capelli-castani' : {
        'name' : 'Sunglasses',
        'description' : "Conocorso a tema dedicato agli occhiali da sole.",
        'rules' : ['Valide solo foto in occhiali da sole'],
        'like_limit' : 20,
        'order' : 5000,
    },
    'capelli-biondi' : {
        'name' : 'Sunglasses',
        'description' : "Concorso dedicato a chi ha i capelli biondi.",
        'rules' : ['Valide solo foto in occhiali da sole'],
        'like_limit' : 20,
        'order' : 5000,
    },
